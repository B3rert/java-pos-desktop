 ...
 * @author dsdev
 */
public class BuscarDes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Buscar descripcion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarDes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
