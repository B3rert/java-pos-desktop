 ...
 * @author dsdev
 */
public class BuscarCod extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarCod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void consultar() {
        ...
        String sql = "SELECT * FROM productos WHERE CODIGOPRODUCTO LIKE '%" + txtSearch.getText() + "%'";
